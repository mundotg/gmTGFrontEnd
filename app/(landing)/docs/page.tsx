  ...
  const menu = useMemo(() => [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "db-engine", label: "Engine de Base de Dados" }
      ]
    }
  ], [t]);
                  ...
                  {group.items.map((item) => (
                    <li key={item.id}>
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-sm font-bold rounded-xl transition-all flex items-center justify-between group ${activeSection === item.id
              ...
              <article className="space-y-10">
                <header className="space-y-4">
                  ...
                  <h2 className="text-4xl font-black tracking-tighter">
                    Engine de Base de Dados
                  </h2>
                  <p className="text-gray-500 font-medium leading-relaxed">
                    Esta secção descreve como os Sistemas de Gestão de Base de Dados (SGBDs)
                    são construídos internamente, incluindo linguagens de baixo nível,
                    armazenamento em disco, gestão de memória e execução de queries.
                  </p>
                </header>
                ...
                <div className="grid gap-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Code2 size={18} className="text-blue-600" /> Linguagens de Criação
                    </h3>
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Database size={18} className="text-blue-600" /> Armazenamento em Disco
                    </h3>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                      Os dados são armazenados em ficheiros binários estruturados em páginas
                      (blocos de tamanho fixo). Cada página contém múltiplas linhas de dados
                      e metadados.
                    </p>

                    <pre className="mt-4 text-xs bg-gray-900 text-white p-4 rounded-xl overflow-auto">
                      {`/data/
 ├── users.dat
 ├── users.idx
 └── wal.log`}
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Share2 size={18} className="text-blue-600" /> Índices (B-Tree)
                    </h3>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                      Para acelerar consultas, os SGBDs utilizam estruturas como B-Trees,
                      permitindo buscas em tempo logarítmico (O(log n)) ao invés de percorrer
                      toda a tabela.
                    </p>
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Cpu size={18} className="text-blue-600" /> Gestão de Memória
                    </h3>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                      O Buffer Pool mantém dados frequentemente acessados em memória RAM,
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Terminal size={18} className="text-blue-600" /> Write-Ahead Logging (WAL)
                    </h3>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                      Antes de qualquer escrita em disco, as operações são registadas num log.
                      Isso garante recuperação de dados em caso de falhas e suporte às
                      propriedades ACID.
                    </p>
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                      <Zap size={18} className="text-blue-600" /> Execução de Queries
                    </h3>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                      O processamento de queries segue três etapas principais:
                      parsing, planejamento e execução. O otimizador escolhe a melhor
                      estratégia para acessar os dados.
                    </p>
